---
name: pming
description: Set up an AI-powered PM workspace with structured context, 6 PM skills, and compounding memory. Creates all files and directories needed for your AI assistant to become a real thinking partner. Use on first use or to set up a new workspace.
---
